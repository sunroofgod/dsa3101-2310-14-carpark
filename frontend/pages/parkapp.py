...
layout = dbc.Container([
    dbc.Row([
        ...
        dbc.Col([
            html.Div([html.B("Select Date"),
            dcc.DatePickerSingle(id='date-picker', date='2023-01-01')]),
            html.Br(),
            html.Div([html.B("Select Time"),
            dcc.Input(id="time-picker", type="text", placeholder="hh:mm:ss", style={'text-align':'center', 'width':'150px'})]),
            html.Br(),
